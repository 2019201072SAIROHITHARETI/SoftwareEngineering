...
import tkinter as Tkinter                  #The python gui interface for Tk gui extension we 're using
from tkinter import filedialog, ttk                   #Module providing access to the Tk themed widget set
...
class Application(Tkinter.Tk):
    ...
    def reg_user(self):
        ...
        try:
            ...
            self.conn.send(string.encode()) #Sending username and password for storing in the database
        except:    
